...
struct DurationFormattingTests {
    @Test(arguments: [
        ...
        (locale: "de_DE", expected: CICUMajorVersion > 60 ? "3 Std., 24 Min. und 42 Sek." : "3 Std., 24 Min. und 42 s"),
        ...
        (locale: "de_CH", expected: CICUMajorVersion > 60 ? "3 Std., 24 Min. und 42 Sek." : "3 Std., 24 Min. und 42 s"),
    ])
    ...
    @Test(arguments: [
        ...
        (locale: "de_DE", expected: CICUMajorVersion > 60 ? "3 Std., 42 Sek." : "3 Std., 42 s"),
        ...
        (locale: "de_CH", expected: CICUMajorVersion > 60 ? "3 Std., 42 Sek." : "3 Std., 42 s"),
    ])
    ...
    @Test(arguments: [
        ...
        (locale: "de_DE", expected: CICUMajorVersion > 60 ? "3 Std., 0 Min. und 42 Sek." : "3 Std., 0 Min. und 42 s"),
        ...
        (locale: "de_CH", expected: CICUMajorVersion > 60 ? "3 Std., 0 Min. und 42 Sek." : "3 Std., 0 Min. und 42 s"),
    ])
